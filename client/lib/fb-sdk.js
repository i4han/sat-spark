/*1435922996,,JIT Construction: v1819022,en_US*/
...
__d("sdk.AppEvents",["Assert","sdk.Impressions","sdk.Runtime"],__annotator(function $module_sdk_AppEvents(global,require,requireDynamic,requireLazy,module,exports,Assert,Impressions,Runtime) {require.__markCompiled && require.__markCompiled();
...
}, {"params":[[appID, 'string', 'appID'], [eventName, 'string', 'eventName'], [valueToSum, '?number', 'valueToSum'], [params, '?object', 'params']]});}__annotator(logEvent, {"module":"sdk.AppEvents","line":51,"column":0,"name":"logEvent"}, {"params":["string","string","?number","?object"]});

function isValidEventName(/*string*/ eventName) /*boolean*/ {return __bodyWrapper(this, arguments, function() {
  if (eventName === null ||
    eventName.length === 0 ||
  ...
  return true;
}, {"params":[[eventName, 'string', 'eventName']],"returns":'boolean'});}__annotator(isValidEventName, {"module":"sdk.AppEvents","line":81,"column":0,"name":"isValidEventName"}, {"params":["string"],"returns":"boolean"});
...
}, {"params":[[appID, 'string', 'appID'], [purchaseAmount, 'number', 'purchaseAmount'], [currency, 'string', 'currency'], [params, '?object', 'params']]});}__annotator(logPurchase, {"module":"sdk.AppEvents","line":93,"column":0,"name":"logPurchase"}, {"params":["string","number","string","?object"]});

function activateApp(/*string*/ appID) {return __bodyWrapper(this, arguments, function() {
  logEvent(appID, HiddenEventNames.ACTIVATED_APP);
}, {"params":[[appID, 'string', 'appID']]});}__annotator(activateApp, {"module":"sdk.AppEvents","line":112,"column":0,"name":"activateApp"}, {"params":["string"]});
...
}, {"module":"sdk.AppEvents","line":7,"column":63,"name":"$module_sdk_AppEvents"}),null);


__d("legacy:fb.appevents",["Assert","sdk.AppEvents","FB","sdk.feature","sdk.Runtime"],__annotator(function $module_legacy_fb_appevents(global,require,requireDynamic,requireLazy,__DO_NOT_USE__module,__DO_NOT_USE__exports,Assert,AppEvents,FB,feature,Runtime) {require.__markCompiled && require.__markCompiled();
...
FB.provide('AppEvents', {
  ...
  }, {"params":[[eventName, 'string', 'eventName'], [valueToSum, '?number', 'valueToSum'], [params, '?object', 'params']]});}, {"module":"legacy:fb.appevents","line":15,"column":11}, {"params":["string","?number","?object"]}),
  ...
  }, {"params":[[purchaseAmount, 'number', 'purchaseAmount'], [currency, 'string', 'currency'], [params, '?object', 'params']]});}, {"module":"legacy:fb.appevents","line":36,"column":14}, {"params":["number","string","?object"]}),
  ...
  }, {"module":"legacy:fb.appevents","line":57,"column":14}),
...
}, {"module":"legacy:fb.appevents","line":7,"column":86,"name":"$module_legacy_fb_appevents"}),3);
...
__d("legacy:fb.canvas.syncrequests",["sdk.RPC","sdk.Event"],__annotator(function $module_legacy_fb_canvas_syncrequests(global,require,requireDynamic,requireLazy,__DO_NOT_USE__module,__DO_NOT_USE__exports,RPC,Event) {require.__markCompiled && require.__markCompiled();



RPC.stub('initPendingSyncRequests');
function subscriptionAdded(/*string*/ name, /*array*/ callbacks) {return __bodyWrapper(this, arguments, function() {
  if (name != 'canvas.syncRequestUpdated') {
    return;
  }
  RPC.remote.initPendingSyncRequests();
  Event.unsubscribe(Event.SUBSCRIBE, subscriptionAdded);
}, {"params":[[name, 'string', 'name'], [callbacks, 'array', 'callbacks']]});}__annotator(subscriptionAdded, {"module":"legacy:fb.canvas.syncrequests","line":10,"column":0,"name":"subscriptionAdded"}, {"params":["string","array"]});

Event.subscribe(Event.SUBSCRIBE, subscriptionAdded);


}, {"module":"legacy:fb.canvas.syncrequests","line":5,"column":60,"name":"$module_legacy_fb_canvas_syncrequests"}),3);
...
__d("legacy:fb.canvas.presence",["sdk.RPC","sdk.Event"],__annotator(function $module_legacy_fb_canvas_presence(global,require,requireDynamic,requireLazy,__DO_NOT_USE__module,__DO_NOT_USE__exports,RPC,Event) {require.__markCompiled && require.__markCompiled();
...
}, {"params":[[name, 'string', 'name'], [callbacks, 'array', 'callbacks']]});}__annotator(subscriptionAdded, {"module":"legacy:fb.canvas.presence","line":13,"column":0,"name":"subscriptionAdded"}, {"params":["string","array"]});

function subscriptionRemoved(/*string*/ name, /*array*/ callbacks) {return __bodyWrapper(this, arguments, function() {
  if (name != 'canvas.friendsOnlineUpdated') {
    return;
  }
...
}, {"params":[[name, 'string', 'name'], [callbacks, 'array', 'callbacks']]});}__annotator(subscriptionRemoved, {"module":"legacy:fb.canvas.presence","line":22,"column":0,"name":"subscriptionRemoved"}, {"params":["string","array"]});


}, {"module":"legacy:fb.canvas.presence","line":5,"column":56,"name":"$module_legacy_fb_canvas_presence"}),3);
...
__d("legacy:fb.versioned-sdk",["sdk.Runtime"],__annotator(function $module_legacy_fb_versioned_sdk(global,require,requireDynamic,requireLazy,__DO_NOT_USE__module,__DO_NOT_USE__exports,Runtime) {require.__markCompiled && require.__markCompiled();

Runtime.setIsVersioned(true);


}, {"module":"legacy:fb.versioned-sdk","line":4,"column":46,"name":"$module_legacy_fb_versioned_sdk"}),3);
